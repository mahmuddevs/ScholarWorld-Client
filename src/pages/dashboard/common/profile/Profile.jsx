                    ...
                    <div className="md:flex">
                        <div className="md:w-1/3 bg-brand-primary p-8 flex flex-col items-center justify-center">
                            ...
                            <button
                                ...
                                className="w-full px-6 py-3 bg-white text-brand-primary font-semibold rounded-full hover:bg-brand-accent hover:text-white transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-brand-accent focus:ring-opacity-50"
                            >
                                Edit Profile
                            </button>
                        </div>
                        <div className="md:w-2/3 p-8">
                            <div className="mb-6">
                                ...
                                <p className="text-xl text-brand-secondary font-semibold">
                                    {userType === "user" ? "student" : userType}
                                </p>
                            </div>
                            <div className="bg-brand-background rounded-lg p-6 mb-6">
                                ...
                                <div className="flex items-center mb-4">
                                    <svg
                                        className="w-6 h-6 text-brand-accent mr-3"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
